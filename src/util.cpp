...
const char * const BITCOIN_CONF_FILENAME = "pakcoin.conf";
const char * const BITCOIN_PID_FILENAME = "pakcoin.pid";
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Pakcoin";
#else
    // Unix
