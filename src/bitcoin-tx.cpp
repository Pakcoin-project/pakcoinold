...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pakcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pakcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pakcoin transaction") + "\n" +
              "  pakcoin-tx [options] -create [commands]   " + _("Create hex-encoded pakcoin transaction") + "\n" +
              "\n";
